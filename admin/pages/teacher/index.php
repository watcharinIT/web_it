    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="form-create.php" class="btn btn-primary float-right ">Add Teacher +-*/</a href="">
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table id="dataTable" class="table table-bordered table-striped">
            ...
            ?>
              <tr>
                <td><?php echo $num; ?></td>
                <td><img class="img-fluid d-block mx-auto" src="../../../assets/images/profile/<?php echo $row['img']; ?>" width="150px" alt=""></td>
                <td><?php echo $row['name']; ?></td>
                <td><?php echo $row['lastname']; ?></td>
                <td><?php echo $row['edu_back1']; ?></td>
